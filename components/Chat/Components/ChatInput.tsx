...
export default function ChatInput() {
    ...
    return (
        <div className="absolute bottom-0 left-0 w-full pt-6 bg-gradient-to-b from-transparent border-white/20 via-mygpt-second to-mygpt">
            ...
            <div className="px-3 pt-2 pb-3 text-center text-[12px] text-white/50 md:px-4 md:pt-3 md:pb-6">
